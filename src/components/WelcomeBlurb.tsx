...
const MotionBlurb = ({ children, open }) => { 
  return (
    <motion.ul variants={ListVariants} initial="hidden" animate={open ? 'visible' : 'hidden'}>
  ...
  return (
    <div className="welcomeBlurb">
      <MotionBlurb open={state.open}>
        ...
        <h4 className="darkHighlight">Still under construction 👷</h4>
      </MotionBlurb>
    </div>
  )
};
